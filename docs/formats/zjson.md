...
sufficient for the [super-structured data model](./README.md#2-zed-a-super-structured-pattern).  That said, JSON can be used as an encoding format for super data by another layer 
of encoding into a JSON-based protocol.  This allows clients like web apps or
