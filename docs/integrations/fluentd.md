...
For Zeek data specifically, a [reference shaper](zeek/shaping-zeek-json#reference-shaper-contents)
...
[here](zeek/shaping-zeek-json#reference-shaper-contents) to a file
...
The lake stores the data for each [`load`](../commands/super-db#load)
...
[data objects](../lake/format#data-objects), allowing for better query performance
as data volumes increase.

By default, even after compaction is performed, the granular commit history is
still maintained to allow for [time travel](../commands/super-db#time-travel)
...
[`zed vacuum`](../commands/super-db#vacuum). This will delete files from lake
